...
enum Strings {
    static let table: [String: [String: String]] = [
        "fr": [
            ...
            // Compte Plaud (état du token + reconnexion)
            "settings_plaud_account": "Compte Plaud",
            "plaud_status_connected": "Connecté",
            "plaud_status_expired_refreshable": "Token expiré — renouvellement automatique au prochain accès.",
            "plaud_status_expired": "Session expirée — reconnexion nécessaire.",
            "plaud_status_absent": "Non connecté — aucun token trouvé.",
            "plaud_token_valid_until": "Token valide jusqu'au",
            "plaud_refresh_now": "Renouveler le token",
            "plaud_refresh_ok": "Token renouvelé. ✅",
            "plaud_reconnect_help": "La connexion passe par Claude Code : lancer le login du MCP Plaud régénère ~/.plaud/tokens-mcp.json, que l'app recharge automatiquement.",
        ...
        "en": [
            ...
            // Plaud account (token status + reconnection)
            "settings_plaud_account": "Plaud account",
            "plaud_status_connected": "Connected",
            "plaud_status_expired_refreshable": "Token expired — it will refresh automatically on next access.",
            "plaud_status_expired": "Session expired — you need to reconnect.",
            "plaud_status_absent": "Not connected — no token found.",
            "plaud_token_valid_until": "Token valid until",
            "plaud_refresh_now": "Renew token",
            "plaud_refresh_ok": "Token renewed. ✅",
            "plaud_reconnect_help": "Sign-in happens through Claude Code: running the Plaud MCP login regenerates ~/.plaud/tokens-mcp.json, which the app picks up automatically.",
        ...
        "zh": [
            ...
            // Plaud 账户（令牌状态 + 重新连接）
            "settings_plaud_account": "Plaud 账户",
            "plaud_status_connected": "已连接",
            "plaud_status_expired_refreshable": "令牌已过期——下次访问时将自动续期。",
            "plaud_status_expired": "会话已过期——需要重新连接。",
            "plaud_status_absent": "未连接——未找到令牌。",
            "plaud_token_valid_until": "令牌有效期至",
            "plaud_refresh_now": "续订令牌",
            "plaud_refresh_ok": "令牌已续订。✅",
            "plaud_reconnect_help": "登录通过 Claude Code 完成：运行 Plaud MCP 的 login 会重新生成 ~/.plaud/tokens-mcp.json，应用会自动读取。",
